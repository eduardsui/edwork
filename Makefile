...
SRC = $(USRSCTP_SRC) src/sha256.c src/xxhash.c src/base64.c src/base32.c src/parson.c src/edd25519.c src/avl.c src/chacha.c src/log.c src/sha3.c src/curve25519.c src/sort.c src/blockchain.c src/edwork.c src/edfs_core.c src/edfs_fuse.c
OBJS = $(SRC: .c=.o)
