...
static const char EDFS_JS_API[] = ""
    "var edwork = {\n"
        ...
        "\"ui\": {\n"
            ...
            "\"call\": function(method, arg, callback) { var self = this; this.__windowcallback = function(str) { if (callback) callback(str); delete self.__windowcallback; }; return __edfs_private_call(method, (typeof arg === \"string\") ? arg : JSON.stringify(arg)); },\n"
