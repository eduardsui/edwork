...
#define EDWORK_VOTE_WORK_LEVEL      EDWORK_LIST_WORK_LEVEL
#define EDWORK_VOTE_WORK_PREFIX     EDWORK_LIST_WORK_PREFIX

#define EDWORK_ROOT_WORK_LEVEL      EDWORK_LIST_WORK_LEVEL
#define EDWORK_ROOT_WORK_PREFIX     EDWORK_LIST_WORK_PREFIX

#define EDWORK_ID_EXPIRES           600
#define EDWORK_VOTE_TIMEOUT         5

#define EDWORK_PING_INTERVAL        20
#define EDWORK_LIST_INTERVAL        300
